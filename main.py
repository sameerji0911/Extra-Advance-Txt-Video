...
async def account_login(bot: Client, m: Message):
    editable = await m.reply_text(f"**Ａｓｓｌａｍｕａｌｅｋｕｍ  ☪️🇸🇦🇸🇦**\n**Bot Made BY S♥A♥M♥E♥E♥R™🇸🇦**")
...
@bot.on_message(filters.command(["sa","deaduser"]) )
async def txt_handler(bot: Client, m: Message):
    ...
    await editable.edit("<pre><code>**Enter Ａｓｓｌａｍｕａｌｅｋｕｍ ☪🇸🇦🇸🇦 आप अपना नामे लिखे 🥰**</code></pre>\n<pre><code>Send `de` for use default</code></pre>")
    ...
    try:
        for i in range(arg-1, len(links)):
            ...
            try:  
                cc = f'**\n╭──────.★..─╮\n{str(count).zfill(3)}\n╰─..★.──────╯**\n\n**📝 Title:** {name1} \n**├── Extention ➫** 𝔖𝔄𝔐𝔈𝔈ℜ 💝.mkv\n**├── Resolution :** [{res}]\n\n<pre><quote>📚 Batch Name: {b_name}</quote></pre>\n\n**💠 𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 ➱**\n╭──────────.✨..─╮\n\n{CR}\n\n╰─..✨.──────────╯\n\n**<pre><code>━━━━━✦Şค๓ēēr✦━━━━━</code></pre>**'
                cc1 = f'**\n╭──────.★..─╮\n{str(count).zfill(3)}\n╰─..★.──────╯**\n\n**📝 Title:** {name1} \n**├── Extention ➫** 𝔖𝔄𝔐𝔈𝔈ℜ 💝.pdf\n**├── Resolution :** [None]\n\n<pre><quote>📚 Batch Name: {b_name}</quote></pre>\n\n**💠 𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 ➱**\n╭──────────.✨..─╮\n\n{CR}\n\n╰─..✨.──────────╯\n\n**<pre><code>━━━━━✦Şค๓ēēr✦━━━━━</code></pre>**'
                cczip = f'<pre><quote>——— ✦  {str(count).zfill(3)} ✦ ———</quote></pre>\n\n📁𝐓𝐢𝐭𝐥𝐞 » `{name1}` .zip\n\n<pre><code>📚 Course : {b_name}</code></pre>\n\n💠 𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 ➱ **\n╭──────────.✨..─╮\n\n{CR}\n\n╰─..✨.──────────╯\n\n**<pre><code>━━━━━✦Şค๓ēēr✦━━━━━</code></pre>**'  
                ccimg = f'**\n╭──────.★..─╮\n{str(count).zfill(3)}\n╰─..★.──────╯**\n\n**📝 Title:** {name1} \n**├── Extention ➫** 𝔖𝔄𝔐𝔈𝔈ℜ 💝.jpg\n**├── Resolution :** [None]\n\n<pre><quote>📚 Batch Name: {b_name}</quote></pre>\n\n**💠 𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 ➱**\n╭──────────.✨..─╮\n\{CR}\n\n╰─..✨.──────────╯\n\n**<pre><code>━━━━━✦Şค๓ēēr✦━━━━━</code></pre>**'
                ccyt = f'<pre><quote>——— ✦  {str(count).zfill(3)} ✦ ———</quote></pre>\n\n🎞️𝐓𝐢𝐭𝐥𝐞 » `{name1}` .mp4\n\n<a href="{url}">__**Click Here to Watch Stream**__</a>\n\n<pre><quote>📚 Course : {b_name}</quote></pre>\n\n💠 𝐄𝐗𝐓𝐑𝐀𝐂𝐓𝐄𝐃 𝐁𝐘 ➱ `{CR}`\n**\n╭──────────.✨..─╮\n\n{CR}\n\n╰─..✨.──────────╯\n\n**<pre><code>━━━━━✦Şค๓ēēr✦━━━━━</code></pre>**'
    ...
    await m.reply_text("<pre><code>🔰Done🔰\n\nDownloaded By ⌈★彡 ร𝔸๓ⓔẸｒ 彡★⌋</code></pre>")
...
async def text_handler(bot: Client, m: Message):
    ...
    await editable.edit("<pre><code>╭━━━━❰ᴇɴᴛᴇʀ ʀᴇꜱᴏʟᴜᴛɪᴏɴ❱━━➣ </code></pre>\n┣━━⪼ send `144`  for 144p\n┣━━⪼ send `240`  for 240p\n┣━━⪼ send `360`  for 360p\n┣━━⪼ send `480`  for 480p\n┣━━⪼ send `720`  for 720p\n┣━━⪼ send `1080` for 1080p\n<pre><code>╰━━⌈⚡SA ѕαмєєя SA⚡⌋━━➣ </code></pre>")
    ...
    await editable.edit("<pre><code>**Enter  @ASPSIR9**</code></pre>\n<pre><code>Send `de` for use default</code></pre>")
    input3: Message = await bot.listen(editable.chat.id)
    raw_text3 = input3.text
    await input3.delete(True)
    if raw_text3 == 'de':
